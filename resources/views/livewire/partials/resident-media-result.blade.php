<div class="p-4">
    <div class="flex items-start justify-between gap-2">
        ...
        @if (($result['status'] ?? null) === 'staged')
            <x-mary-badge value="Staged" class="badge-warning badge-sm" />
    ...
    @endif
    <p class="mt-1 text-xs text-gray-500">Resident ID: {{ $result['resident_id'] ?: 'Could not be determined' }}</p>
