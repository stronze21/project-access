...
<div x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}"
    :class="{ 'bg-[var(--brand-secondary)]': style == 'success', 'bg-red-700': style == 'danger', 'bg-[var(--brand-accent)]': style == 'warning', 'bg-[var(--brand-primary)]': style != 'success' && style != 'danger' && style != 'warning'}"
            style="display: none;"
            x-show="show && message"
    ...
    <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between flex-wrap">
            <div class="w-0 flex-1 flex items-center min-w-0">
                <span class="flex p-2 rounded-lg" :class="{ 'bg-[var(--brand-secondary-strong)]': style == 'success', 'bg-red-600': style == 'danger', 'bg-amber-600': style == 'warning', 'bg-[var(--brand-primary-strong)]': style != 'success' && style != 'danger' && style != 'warning' }">
            ...
            <div class="shrink-0 sm:ms-3">
                <button
                    ...
                    :class="{ 'hover:bg-[var(--brand-secondary-strong)] focus:bg-[var(--brand-secondary-strong)]': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger', 'hover:bg-amber-600 focus:bg-amber-600': style == 'warning', 'hover:bg-[var(--brand-primary-strong)] focus:bg-[var(--brand-primary-strong)]': style != 'success' && style != 'danger' && style != 'warning'}"
                    aria-label="Dismiss"
